...
| `scripts/verify_share_kit.py` | Verify share kit and social card | `python3 scripts/verify_share_kit.py` | share copy facts, social card shape, links, non-claims | external distribution |
