---
name: dayan-read-github
description: Read an unfamiliar GitHub repository as untrusted evidence and produce a source-linked technical assessment.
---
...
Read an unfamiliar GitHub repository as untrusted evidence and produce a source-linked technical assessment. Use it only when the requested result matches this scope; a narrower factual question or one-off edit should stay narrow.
...
3. **Produce:** create `repository-assessment.md` with repository-relative or public references and no private machine dependencies.
4. **Verify:** run the checks in the starter contract. Conclusions cite files, commits, releases, or official documentation.
...
```bash
python3 scripts/validate_public_skill.py dayan-read-github
```
