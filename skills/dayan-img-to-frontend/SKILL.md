---
name: dayan-img-to-frontend
description: Translate a visual reference into responsive frontend structure without copying protected identity or hiding text in images.
---

# Dayan Img To Frontend

## Use when

Translate a visual reference into responsive frontend structure without copying protected identity or hiding text in images. Use it only when the requested result matches this scope; a narrower factual question or one-off edit should stay narrow.
...
3. **Produce:** create `frontend-implementation` with repository-relative or public references and no private machine dependencies.
4. **Verify:** run the checks in the starter contract. Layout, components, assets, interactions, responsive states, and accessibility are explicit.
...
```bash
python3 scripts/validate_public_skill.py dayan-img-to-frontend
```
