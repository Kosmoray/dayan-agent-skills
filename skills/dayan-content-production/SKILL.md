---
name: dayan-content-production
description: Turn raw conversation or research into a reader-ready content package without leaking internal context.
---

# Dayan Content Production

## Use when

Turn raw conversation or research into a reader-ready content package without leaking internal context. Use it only when the requested result matches this scope; a narrower factual question or one-off edit should stay narrow.
...
3. **Produce:** create `content-package.md` with repository-relative or public references and no private machine dependencies.
4. **Verify:** run the checks in the starter contract. Facts, opinions, private material, unknowns, audience, and publication authority are separated.
...
```bash
python3 scripts/validate_public_skill.py dayan-content-production
```
