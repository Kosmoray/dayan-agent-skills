---
name: dayan-schematic
description: Reverse-engineer an implemented branch into product behavior and technical specifications.
---
...
Reverse-engineer an implemented branch into product behavior and technical specifications. Use it only when the requested result matches this scope; a narrower factual question or one-off edit should stay narrow.
...
3. **Produce:** create `implementation-spec.md` with repository-relative or public references and no private machine dependencies.
4. **Verify:** run the checks in the starter contract. Every requirement maps to code, test, or observed behavior.
...
```bash
python3 scripts/validate_public_skill.py dayan-schematic
```
