...
- real trigger and output smoke tests across current Codex and Claude Code product versions;
...
Public beta means the package is installable, source-available, sanitized, and structurally verified. It is not a claim of universal runtime compatibility or external outcome.
