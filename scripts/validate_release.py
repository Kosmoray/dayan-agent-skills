...
def main() -> int:
    ...
    if catalog.get("release") != "1.7.1-beta.1":
        errors.append("catalog release must be 1.7.1-beta.1")
    ...
    if len(beta_names) != 56:
        errors.append("all 56 catalog Skills must be public beta in v1.7.1-beta.1")
